...
public class ElectronicItem {
    ...
    private static List<ElectronicItem> electronicList = new ArrayList<>();
    ...
    public static void addNewItem() {
        ...
        while (flag) {
            ...
            electronicItem.setId(itemId);
            scanner.nextLine();
            System.out.println("Enter item name");
            String itemName = scanner.nextLine();
            electronicItem.setName(itemName);

            System.out.println("Enter item price");
            float itemPrice = scanner.nextFloat();
            scanner.nextLine();
            electronicItem.setPrice(itemPrice);

            System.out.println("Enter item brand");
            String itemBrand = scanner.nextLine();
            scanner.nextLine();
            electronicItem.setBrand(itemBrand);

            electronicList.add(electronicItem);
    ...
    public static void editExistingItem() {
        ...
        boolean found = false;
        for (ElectronicItem item : electronicList) {
    ...
    public static void removeItem() {
        ...
        for (int i = 0; i < electronicList.size(); i++) {
            if (electronicList.get(i).getId().equals(userInput)) {
                electronicList.remove(i);
    ...
    public static void displayAllItems() {
        ...
        for (ElectronicItem c : electronicList) {
